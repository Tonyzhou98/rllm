...
srun --nodes=1 --ntasks=1 --overlap -w "$head_node" vllm serve /checkpoints/zyhang/algoevolve/algoevolve_qwen3_8b_mle_syn_single_node_median_reward/global_step_70/actor/huggingface \
  --trust-remote-code \
  --seed=1 \
  --port 8001 \

...
#SBATCH --error=/fsx/zyhang/rllm/examples/deepresearch/slurm/mle_syn_qwen3_235b_megatron_rl_grpo_agent_multi_nodes.stderr
...
export SRUN_API_URL="http://10.136.70.153:9000"
...
experiment_name="algoevolve_qwen3_235b_mle_syn_multi_nodes_megatron"
...
PYTHONUNBUFFERED=1 srun --overlap --nodes=1 --ntasks=1 -w "$head_node" \
  bash -c "
    ...
    python3 -m examples.deepresearch.custom_train_megatron \
      ...
      actor_rollout_ref.model.path=/fsx/zyhang/Qwen/Qwen3-235B-A22B-Thinking-2507 \

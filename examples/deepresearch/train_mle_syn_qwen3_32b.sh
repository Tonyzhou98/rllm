...
#SBATCH --output=/fsx/zyhang/rllm/examples/deepresearch/slurm/mle_syn_qwen3_32b_rl_grpo_agent_single_node_filter_timeout.stdout
#SBATCH --error=/fsx/zyhang/rllm/examples/deepresearch/slurm/mle_syn_qwen3_32b_rl_grpo_agent_single_node_filter_timeout.stderr
...
experiment_name="algoevolve_qwen3_32b_mle_syn_single_node_filter_timeout"
...
PYTHONUNBUFFERED=1 bash -c "python3 -m examples.deepresearch.custom_train \
    ...
    actor_rollout_ref.model.path=/fsx/zyhang/Qwen/Qwen3-32B \
